 ...
 * managing the configuration of Subposts.
 *
...
final class Manager extends Handler {
	...
	public static function add_menu_pages() {
		...
		$options_page_hook = add_utility_page(
			__( 'Subposts Options', 'subposts' ), // page title
			_x( 'Subposts', 'menu title', 'subposts' ), // menu title
			'manage_options', // capability
			'subposts-options', // slug
	...
	public static function register_settings() {
		register_setting( 'subposts-options', 'subposts_options', array( __CLASS__, 'update_options' ) );
	...
	public static function update_options( $updated_options ) {
		$all_options = get_option( 'subposts_options', array() );
	...
	protected static function setup_options_fields() {
		...
		add_settings_section( 'default', null, null, 'subposts-options' );
